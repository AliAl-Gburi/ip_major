defmodule AuctionHouse.UserContext do
  @moduledoc """
  ...
  def delete_user(%User{} = user) do
    preloaded = AuctionContext.getAuctionsOfUser(user)
    Enum.each(preloaded.auctions, fn i -> AuctionContext.delete_auction(i) end)
    MetricContext.delete_metric_by_username(user.username)
    Repo.delete(user)
  end
